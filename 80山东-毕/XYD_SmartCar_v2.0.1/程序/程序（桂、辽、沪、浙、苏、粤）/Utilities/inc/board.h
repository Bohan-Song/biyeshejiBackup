...
#define BEEP_ON    GPIO_WriteBit(BEEP_GPIO_PORT, BEEP_GPIO_PIN,Bit_SET);	
#define BEEP_OFF   GPIO_WriteBit(BEEP_GPIO_PORT, BEEP_GPIO_PIN,Bit_RESET);			
/* LED1 -> PA13 */
...
#define LCD_CS_RCC          RCC_APB2Periph_GPIOG

/* LCD RD -> PC10 */
#define LCD_RD_PORT         GPIOD
#define LCD_RD_PIN          GPIO_Pin_4
#define LCD_RD_RCC          RCC_APB2Periph_GPIOD

/* LCD WR -> PC11 */
#define LCD_WR_PORT         GPIOD
#define LCD_WR_PIN          GPIO_Pin_5
#define LCD_WR_RCC          RCC_APB2Periph_GPIOD
